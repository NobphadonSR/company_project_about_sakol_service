...
class ServiceRecord(models.Model):
    ...
    customer = models.ForeignKey('accounts.Customer', on_delete=models.CASCADE, verbose_name='ลูกค้า', null=True)
    ...
    def __str__(self):
        return f"{self.job_number} - {self.customer.customer_name}"
