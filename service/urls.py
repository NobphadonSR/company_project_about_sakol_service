...
urlpatterns = [
    ...
    path('records/<int:pk>/edit/', views.ServiceRecordUpdateView.as_view(), name='edit_record'),
    path('records/<int:pk>/delete/', views.ServiceRecordDeleteView.as_view(), name='delete_record'),
